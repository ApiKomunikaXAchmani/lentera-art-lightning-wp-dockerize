...
$custom_width = (int)DfdMetaBoxSettings::get('portfolio_single_carousel_img_width');
...
$custom_height = (int)DfdMetaBoxSettings::get('portfolio_single_carousel_img_height');
