...
(function($) {
	...
	$(document).ready(function() {
		if($('body').hasClass('post-type-page') || $('body').hasClass('post-type-post') || $('body').hasClass('post-type-portfolio') || $('body').hasClass('post-type-gallery') || $('body').hasClass('post-type-product') || $('body').hasClass('post-type-dfd-author')) {
			...
			var wooExerptTaxonomyExcludeClass = '';
			if($('body').hasClass('post-type-product')) {
				wooExerptTaxonomyExcludeClass = ':not(#postexcerpt)';
			}
			var $metaBoxes				= $('#normal-sortables')
												.children('.postbox:not(#wpb_visual_composer):not(#wpb_wpbakery):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox):not(#pagebilder_content):not(#custom_content_editor):not(#NS_SNAP_AddPostMetaTags)'+wooExerptTaxonomyExcludeClass)
												.clone(),
				$advancedContainer = $('#advanced-sortables');

			$('#normal-sortables').children('.postbox:not(#wpb_visual_composer):not(#wpb_wpbakery):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox):not(#pagebilder_content):not(#custom_content_editor):not(#NS_SNAP_AddPostMetaTags)'+wooExerptTaxonomyExcludeClass).remove();
