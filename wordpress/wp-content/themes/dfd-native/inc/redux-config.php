...
//        )
	...
	$main_options = array(
		...
		array(
			...
			'type' => 'button_set',
			'title' => esc_html__('Default WPBakery Page Builder modules', 'dfd-native'),
			'options' => array('on' => esc_html__('On', 'dfd-native'), 'off' => esc_html__('Off', 'dfd-native')),
			'default' => 'off',
			'hint' => array(
				'title'   => esc_attr__('Default VC Modules','dfd-native'),
				'content' => esc_attr__('Allows you to enable or disable default modules for the WPBakery Page Builder','dfd-native')
			)
		),
		array(
		...
		'fields' => array(
			...
			array(
				...
				'options' => array(
					...
					'3' => esc_html__('WPBakery page', 'dfd-native'),
		...
		'headings' => array(
			...
			'elements' => array(
				'h1' => array(
					...
					'subtitle' => esc_html__('Specify the typography settings and color for the H1. You can use the H1 as element tag in WPBakery Page Builder modules','dfd-native'),
				),
				'h2' => array(
					'font-family' => 'Montserrat',
					'font-size' => '45px',
					...
					'subtitle' => esc_html__('Specify the typography settings and color for the H2. You can use the H2 as element tag in WPBakery Page Builder modules','dfd-native'),
				),
				'h3' => array(
					'font-family' => 'Montserrat',
					'font-size' => '30px',
					...
					'subtitle' => esc_html__('Specify the typography settings and color for the H3. You can use the H3 as element tag in WPBakery Page Builder modules','dfd-native'),
				),
				'h4' => array(
					'font-family' => 'Montserrat',
					'font-size' => '25px',
					...
					'subtitle' => esc_html__('Specify the typography settings and color for the H4. You can use the H4 as element tag in WPBakery Page Builder modules','dfd-native'),
				),
				'h5' => array(
					'font-family' => 'Montserrat',
					'font-size' => '20px',
					...
					'subtitle' => esc_html__('Specify the typography settings and color for the H5. You can use the H5 as element tag in WPBakery Page Builder modules','dfd-native'),
				),
				'h6' => array(
					'font-family' => 'Montserrat',
					'font-size' => '11px',
					...
					'subtitle' => esc_html__('Specify the typography settings and color for the H6. You can use the H6 as element tag in WPBakery Page Builder modules','dfd-native'),
				),
		...
		'fields' => array(
			...
			array(
				...
				'hint' => array(
					...
					'content' => esc_attr__('This option allows you to choose the displaying of the WPBakery Page Builder content. You can set the content above or below the post items. There is also an option on the item\'s page if you need to change it for single blog posts page','dfd-native')
				)
			),
			array(
	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'button_set',
				'title' => esc_html__('Category\'s description', 'dfd-native'),
				'options' => array('on' => esc_html__('On', 'dfd-native'), 'off' => esc_html__('Off', 'dfd-native')),
				'default' => 'off',
				'hint' => array(
					'title' => esc_attr__('Category description', 'dfd-native'),
					'content' => esc_attr__('This option allows you to display category\'s description on archive page. The decription will be placed above the blog posts items.', 'dfd-native')
				)
			),
			array(
	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'radio',
				'title' => esc_html__('WPBakery default content position', 'dfd-native'),
				'desc' => '',
				'options' => array(
					'top' => esc_html__('Top', 'dfd-native'),
					'bottom' => esc_html__('Bottom', 'dfd-native'),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'hint' => array(
					'title'   => esc_attr__('Content position','dfd-native'),
					'content' => esc_attr__('This option allows you to choose the displaying of the WPBakery Page Builder content. You can set the content above or below the portfolio items. There is also an option on the item\'s page if you need to change it for single portfolio page','dfd-native')
				)
			),
			array(
	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'hint' => array(
					'title'   => esc_attr__('Content position','dfd-native'),
					'content' => esc_attr__('This option allows you to choose the displaying of the WPBakery Page Builder content. You can set the content above or below the gallery items. There is also an option on the item\'s page if you need to change it for single gallery page','dfd-native')
				)
			),
			array(
		...
		'fields' => array(
			...
			array(
				...
				'hint' => array(
						...
						'content' => esc_attr__('This option allows you to choose the main site color. This color is used as default color for the WPBakery Page Builder elements','dfd-native')
					)
			),
			array(
	...
	Redux::setSection( $opt_name, array (
		...
		'fields' => array (
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__('Button text', 'dfd-native'),
				'sub_desc' => esc_html__('Please do not use single quote here', 'dfd-native'),
				'validate' => 'html',
				'default' => 'Button',
				'required' => array( 'is_header_builder_enabled', "=", 'on' ),
