...
if(isset($dfd_native['portfolio_hover_bg_opacity']) && !empty($dfd_native['portfolio_hover_bg_opacity'])) {
	$output .= 'body:not(.elementor-editor-active):not(.elementor-page) .dfd-portfolio .entry-thumb .entry-hover:before,'
			 . 'body:not(.elementor-editor-active):not(.elementor-page) .dfd-portfolio_archive .entry-thumb .entry-hover:before,'
			 . 'body:not(.elementor-editor-active):not(.elementor-page) .dfd-portfolio.dfd-3d-parallax:hover .cover .thumb-wrap:before,'
			 . 'body:not(.elementor-editor-active):not(.elementor-page) .dfd-portfolio_archive.dfd-3d-parallax:hover .cover .thumb-wrap:before {'
	...
	if(isset($dfd_native['portfolio_hover_bg']) && $dfd_native['portfolio_hover_bg']) {
		$output .= '.dfd-portfolio .entry-thumb .entry-hover:before,'
				 ...
				 . '.dfd-portfolio_archive.dfd-3d-parallax:hover .cover .thumb-wrap:before {'
					. ' background: '. $dfd_native['portfolio_hover_bg'] .';'
				 . '}';
	}
}
...
if (
    ...
    $output .= '.dfd-portfolio .entry-thumb .entry-hover:before,'
			 ...
			 . '.dfd-portfolio.dfd-3d-parallax:hover .cover .thumb-wrap:before,'
			 . '.dfd-portfolio_archive.dfd-3d-parallax:hover .cover .thumb-wrap:before {'
				. 'background: -webkit-linear-gradient(left, '.esc_attr($dfd_native['portfolio_hover_bg_gradient']['from']).','.esc_attr($dfd_native['portfolio_hover_bg_gradient']['to']).');'
				. 'background: -moz-linear-gradient(left, '.esc_attr($dfd_native['portfolio_hover_bg_gradient']['from']).','.esc_attr($dfd_native['portfolio_hover_bg_gradient']['to']).');'
				. 'background: -o-linear-gradient(left, '.esc_attr($dfd_native['portfolio_hover_bg_gradient']['from']).','.esc_attr($dfd_native['portfolio_hover_bg_gradient']['to']).');'
				. 'background: -ms-linear-gradient(left, '.esc_attr($dfd_native['portfolio_hover_bg_gradient']['from']).','.esc_attr($dfd_native['portfolio_hover_bg_gradient']['to']).');'
				. 'background: linear-gradient(left, '.esc_attr($dfd_native['portfolio_hover_bg_gradient']['from']).','.esc_attr($dfd_native['portfolio_hover_bg_gradient']['to']).');'
			 . '} ';
}