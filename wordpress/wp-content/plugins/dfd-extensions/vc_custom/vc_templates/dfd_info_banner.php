...
if (!empty($image_hover)) {
	...
	if(!$image_src_hover) {
		$image_url_hover = get_template_directory_uri() . '/assets/images/no_image_resized_120-120.jpg';
		$image_src_hover = array(get_template_directory_uri() . '/assets/images/no_image_resized_120-120.jpg');
	} else {
