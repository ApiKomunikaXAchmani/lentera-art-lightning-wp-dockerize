...
echo '<div id="'.esc_attr($uniqid).'" class="dfd-portfolio-fullscreen-module-wrapper">';
	...
	echo '<div class="dfd-portfolio-module '.esc_attr($el_class).'" '.$data_atts.'>';
		...
		echo '<div class="swiper-navigation-wrap">'
				. '<a href="#" class="dfd-swiper-nav dfd-content-title-small dfd-swiper-prev" title="'.esc_attr__('Previous slide','dfd-native').'">'
					. '<i class="dfd-socicon-arrow-left"></i>'
					. '<span class="counter"></span>'
				. '</a>'
				. '<a href="#" class="dfd-swiper-nav dfd-content-title-small dfd-swiper-next" title="'.esc_attr__('Next slide','dfd-native').'">'
