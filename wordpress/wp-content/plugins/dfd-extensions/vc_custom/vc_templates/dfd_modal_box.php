...
if(isset($modal_border) && !empty($modal_border) || isset($modal_border_width) && !empty($modal_border_width) || isset($modal_border_color) && !empty($modal_border_color)){
	...
	$link_css .= '#'.esc_js($uniqid_box).' .dfd-modal-box-cover .dfd-modal-box-wrap .dfd-socicon-cross-24 {top: -'.esc_js((int)$modal_border_width).'px; padding-left: '.(esc_js((int)$modal_border_width) + 20).'px;}';
}
