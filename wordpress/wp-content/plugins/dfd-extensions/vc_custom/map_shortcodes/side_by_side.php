...
vc_map(array(
	'name'						=>  esc_html__( 'Side by Side slider', 'dfd-native' ),
...
vc_map(array(
	'name'						=>  esc_html__( 'Side by Side Left Container', 'dfd-native' ),
...
vc_map(array(
	'name'						=>  esc_html__( 'Side by Side Right Container', 'dfd-native' ),
...
vc_map(array(
	'name'						=>  esc_html__( 'Side by Side Slider Item', 'dfd-native' ),
	...
	'params'					=> array(
		...
		array(
			'type'				=> 'dropdown',
			'heading'			=> esc_html__('Select Slide Background Style', 'dfd-native'),
			'param_name'		=> 'slide_bg_check',
			'value'				=> array(
				esc_html__('Light background', 'dfd-native')	=> '',
				esc_html__('Dark background', 'dfd-native')	=> 'column-background-dark'
			),
		),
		array(
			'type'				=> 'textfield',
