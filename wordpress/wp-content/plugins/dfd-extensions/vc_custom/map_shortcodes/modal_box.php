...
vc_map(
	array(
		'name'					=> esc_html__('Modal Box', 'dfd-native'),
		'base'					=> 'dfd_modal_box',
		...
		'params'				=> array(
			...
			array(
				'type'				=> 'number',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the delay timeout for the modal box','dfd-native').'</span></span>'.esc_html__('Timeout', 'dfd-native'),
			...
			array(
				'type'				=> 'dropdown',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">' . esc_html__('Choose the appear effect for the overlay', 'dfd-native') . '</span></span>' . esc_html__('Animation', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose background for the overlay. The default color is #000','dfd-native').'</span></span>'.esc_html__('Overlay background', 'dfd-native'),
			...
			array(
				'type'				=> 'number',
				'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the width of the modal box according to the width of the container','dfd-native').'</span></span>'.esc_html__('Modal Box Size', 'dfd-native'),
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose background style for the content','dfd-native').'</span></span>'.esc_html__('Background', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose background color for the content','dfd-native').'</span></span>'.esc_html__('Color background', 'dfd-native'),
			...
			array(
				'type'				=> 'attach_image',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose background image for the content','dfd-native').'</span></span>'.esc_html__('Image background', 'dfd-native'),
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the style for the modal box border','dfd-native').'</span></span>'.esc_html__('Modal box border', 'dfd-native'),
			...
			array(
				'type'				=> 'number',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Specify the border width','dfd-native').'</span></span>'.esc_html__('Border width', 'dfd-native'),
			...
			array(
				'type'				=> 'dropdown',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">' . esc_html__('Choose the appear effect for the button', 'dfd-native') . '</span></span>' . esc_html__('Button animation', 'dfd-native'),
