	...
	array(
		...
		'params' => array(
			...
			array(
				...
				'heading'		=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to choose the visibility options for shadow','dfd-native').'</span></span>'.esc_html__('Shadow visibility', 'dfd-native'),
				'param_name'	=> 'shadow',
				'value'			=> 'disable',
				'options'		=> array(
