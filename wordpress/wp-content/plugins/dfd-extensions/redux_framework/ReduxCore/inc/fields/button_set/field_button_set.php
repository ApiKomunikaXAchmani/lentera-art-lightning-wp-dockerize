    ...
    if ( ! class_exists( 'ReduxFramework_button_set' ) ) {
        ...
        class ReduxFramework_button_set {
            ...
            public function render() {
				...
				$buttons_count = count($this->field['options']);
				$buttons_class = $animation_class = '';
				if($buttons_count == 2) {
					$buttons_class .= 'dfd-options-two-buttons-set';
				}
				if($buttons_count > 2) {
					$buttons_class .= 'dfd-options-few-buttons-set';
				}
                echo '<div class="buttonset ui-buttonset">';
				echo '<div class="buttons-cover '.$buttons_class.'">';
                $i = 1;
				...
				echo '<span class="button-animation '.$animation_class.'"></span>';
				echo '</div>';
                echo '</div>';
            }
