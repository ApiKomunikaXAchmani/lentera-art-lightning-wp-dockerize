        ...
        class ReduxFramework_extension_customizer {
            ...
            public function customizer_save_after( $wp_customize ) {
                ...
                if ( $changed ) {
					...
					if(isset($this->parent->options['enqueue_styles_file']) && strcmp($this->parent->options['enqueue_styles_file'], 'on') === 0) {
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'dfd-native' ),
                    'reset_confirm'  => esc_html__( 'Are you sure? Resetting will lose all custom values.', 'dfd-native' ),
                    'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'dfd-native' ),
